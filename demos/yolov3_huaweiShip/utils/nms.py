...
def non_max_suppression(prediction, conf_thres=0.25, iou_thres=0.45, max_det=300):
    ...
    '''
    :param prediction: torch.Size([25200, 85]) all 3 layers' predict for a individual image : [x,y,w,h,conf, num_classes * scores], within ori image size
    :param conf_thres:
    :param num_classes:
    ...
    # prediction[:, 4:5] = scores # using obj_conf * cls_conf
    ...
    prediction = torch.cat([prediction, categories.view(-1, 1)], dim=1) # x, y, x, y, [conf or obj_conf * cls_conf], category_idx
